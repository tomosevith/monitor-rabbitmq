module "video" {
  ...
  cloudfront_uploader_arn = ["${var.cloudfront_uploader_arn}", "${module.web_front_ssm_role.role_arn}", "${module.web_backend_ssm_role.role_arn}", "${module.converters_ssm_role.role_name}"]
